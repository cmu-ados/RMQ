...
int zmq::options_t::set_curve_key(uint8_t *destination_,
                                  ...
                                  size_t optvallen_) {
  switch (optvallen_) {
    case CURVE_KEYSIZE:memcpy(destination_, optval_, optvallen_);
      mechanism = ZMQ_CURVE;
      return 0;
    ...
    case CURVE_KEYSIZE_Z85:char z85_key[CURVE_KEYSIZE_Z85 + 1];
...
int zmq::options_t::setsockopt(int option_,
  ...
  switch (option_) {
    ...
    case ZMQ_AFFINITY:return do_setsockopt(optval_, optvallen_, &affinity);
    ...
    case ZMQ_MAXMSGSIZE:return do_setsockopt(optval_, optvallen_, &maxmsgsize);
...
int zmq::options_t::getsockopt(int option_,
  ...
  switch (option_) {
    ...
    case ZMQ_SOCKS_PROXY:return do_getsockopt(optval_, optvallen_, socks_proxy_address);
      break;
    ...
    case ZMQ_PLAIN_USERNAME:return do_getsockopt(optval_, optvallen_, plain_username);
      break;

    case ZMQ_PLAIN_PASSWORD:return do_getsockopt(optval_, optvallen_, plain_password);
      break;

    case ZMQ_ZAP_DOMAIN:return do_getsockopt(optval_, optvallen_, zap_domain);
      break;
    ...
    case ZMQ_BINDTODEVICE:return do_getsockopt(optval_, optvallen_, bound_device);
      break;
